...
class Quiz:
    ...
    def __init__(self, how_many):
        ...
        instructions = "What's the animal youth of: {}"
        ...
        for item in range(0, 4):
            self.choice_button = Button(self.choice_frame,
                                        text=self.button_animals_list[item][0],
                                        width=15,
    ...
    def get_round_animals(self):
        ...
        # Get six unique animals
        while len(round_animal_list) < 4:
            chosen_animal = random.choice(self.all_animals)
            index_chosen = self.all_animals.index(chosen_animal)

            if chosen_animal[1] not in animal_scores:
                round_animal_list.append(chosen_animal)
                animal_scores.append(chosen_animal[1])
                self.all_animals.pop(index_chosen)
